...
function addT() {
    ...
    document.getElementById("dqf").value = null;
    document.getElementById("xqf").value = null;
    document.getElementById("zf").value = null;
    document.getElementById("dfhw").value = null;
    document.getElementById("kqhw").value = null;
}
...
function submit1() {
    ...
    var dqf = document.getElementById("dqf").value;
    var xqf = document.getElementById("xqf").value;
    var zf = document.getElementById("zf").value;
    var dfhw = document.getElementById("dfhw").value;
    var kqhw = document.getElementById("kqhw").value;

    // 改变原本得到的数据格式为textNode格式
    name = document.createTextNode(name);
    co = document.createTextNode(co);
    dqf = document.createTextNode(dqf);
    xqf = document.createTextNode(xqf);
    zf = document.createTextNode(zf);
    dfhw = document.createTextNode(dfhw);
    kqhw = document.createTextNode(kqhw);
    ...
    td6.className = "col1";
    td6.appendChild(dfhw);

    var td7 = document.createElement("td");
    td7.className = "col1";
    td7.appendChild(kqhw);
...
function modify(obj) {
    ...
    var co = document.getElementById("co").value = objTd[1].innerText;
    var dqf = document.getElementById("dqf").value = objTd[2].innerText;
    var xqf = document.getElementById("xqf").value = objTd[3].innerText;
    var zf = document.getElementById("zf").value = objTd[4].innerText;
    var dfhw = document.getElementById("dfhw").value = objTd[5].innerText;
    var kqhw = document.getElementById("kqhw").value = objTd[6].innerText;
}
...
function submit2() {
    ...
    objTd[1].innerText = document.getElementById("co").value;
    objTd[2].innerText = document.getElementById("dqf").value;
    objTd[3].innerText = document.getElementById("xqf").value;
    objTd[4].innerText = document.getElementById("zf").value;
    objTd[5].innerText = document.getElementById("dfhw").value;
    objTd[6].innerText = document.getElementById("kqhw").value;
